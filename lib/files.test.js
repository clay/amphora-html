...
describe(_.startCase(filename), function () {
  ...
  describe('isDirectory', function () {
    ...
    it('returns false if not a directory', () => {
      fs.statSync.withArgs('components/c1').returns(createMockStat({isDirectory: false}));
  ...
  describe('getFolders', function () {
    ...
    it('returns empty Array if no folders exist', () => {
      fs.statSync.withArgs('components/').returns(undefined);
