...
function injectScriptsAndStyles(state) {
  ...
  return function (html) {
    ...
    if (!!mediaMap.manifestRuntime) {
      mediaMap.manifestRuntime = injectTags(mediaMap.manifestRuntime, locals.site, SCRIPT_TAG);
    }
    if (!!mediaMap.manifestGlobals) {
      mediaMap.manifestGlobals = injectTags(mediaMap.manifestGlobals, locals.site, ASYNC_SCRIPT_TAG);
    }

    if (!!mediaMap.manifestComponents) {
      mediaMap.manifestComponents = injectTags(mediaMap.manifestComponents, locals.site, ASYNC_DEFER_SCRIPT_TAG);
    }

    if (!!mediaMap.manifestInit) {
      mediaMap.manifestInit = injectTags(mediaMap.manifestInit, locals.site, ASYNC_DEFER_SCRIPT_TAG);
    }
