...
describe(_.startCase(filename), function () {
  ...
  describe('getStyles', function () {
    ...
    it('if a styleguide is set, base component styles are not grabbed', function () {
      ...
      expect(fn('name', {
        slug: 'foo',
        styleguide: 'bar'
      })).to.deep.equal(['/css/name.bar.css']);
    });

    it('if a styleguide is set and there are variations available, grab those variation files', function () {
      files.fileExists.withArgs(`${process.cwd()}/public/css/name.bar.css`).returns(true);
      files.fileExists.withArgs(`${process.cwd()}/public/css/name_foo.bar.css`).returns(true);
  ...
  describe('getScripts', function () {
    ...
    it('accepts good component and its client.js file', function () {
      files.fileExists.withArgs('/foo/js/name.js').returns(true);
      files.fileExists.withArgs('/foo/js/name.foo.js').returns(true);
      files.fileExists.withArgs('/foo/js/name.client.js').returns(true);

      expect(fn('name', state.locals.site)).to.deep.equal(['/js/name.js', '/js/name.foo.js', '/js/name.client.js']);
    });
