...
describe(_.startCase(filename), function () {
  let sandbox,
    ...
    componentScriptHtml = '<html><head></head><body><script type="text/javascript"><![CDATA[ ' + scriptString + ' ]]</script></body></html>',
    ...
    componentScriptSection = '<section><header></header><footer></footer><script type="text/javascript"><![CDATA[ ' + scriptString + ' ]]</script></section>',
