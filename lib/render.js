...
function makeState(data, meta) {
  ...
  // note: if styleguide isn't set, this gets variations from the 'default' styleguide
  initialState._componentVariations = styleguide.getVariations(_.get(meta, 'locals.site.styleguide', 'default'));
