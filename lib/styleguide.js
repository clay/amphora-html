...
*/
function getVariations(styleguide = 'default') {
  const foundVariations = styleguide !== 'default' ? findVariationFiles(styleguide).concat(findVariationFiles('default')) : findVariationFiles('default'),
    componentVariations = {};
