...
describe(_.startCase(filename), function () {
  ...
  beforeEach(function () {
    ...
    files.getFiles.withArgs('styleguides/default/components').returns(defaultMockData);
  ...
  it('gets default variations', function () {
    ...
    expect(lib.getVariations('default')).to.deep.equal(expected);
  });
  ...
  it('set default variations for components that have variations but none set', function () {
    ...
    lib.setDefaultVariations(testData, variations);
